...
import { TopSellingData } from "../../data/kfcData";
    ...
    <>
      {TopSellingData.map((item) => {
        ...
        return (
          <div
            key={id}
            className={`${backgroundColorClass} ${textColorClass} p-3 rounded-md flex flex-col gap-3 border-[1px] border-transparent hover:border-red-600 ease-in-out duration-500`}
          >
            <div>
              <img src={img} alt="" />
              <div className="flex justify-start items-center gap-3">
                <div
                  className={`border-[2px] ${
                    type == "nonveg" ? "border-red-600" : "border-green-500"
                  } flex items-center justify-center p-1`}
                >
                  <div
                    className={` ${
                      type == "nonveg" ? "bg-red-600" : "bg-green-500"
